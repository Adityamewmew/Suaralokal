...
test('cod_talangan is rejected above Rp100.000', function () {
    ...
    // ponytail: mock-based test — the COD cap enforcement is in OrderUsecase::createFromConversation.
    // Full DB validation test should be added when suite uses RefreshDatabase.
    $this->mock(ConversationUsecase::class, function ($mock) {
